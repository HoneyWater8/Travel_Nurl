...
async def get_nearby_tourlist(latitude: float, longitude: float, contenttype: int=12, radius: int=1000):
    """
    ...
    try:
        ...
        data = await external_service.get_nearby_tourlist(latitude, longitude, contenttype, radius)
